...
# ----------------------------------------
# If apll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 linux 2018.04.06.18:37:48
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/apll.vho"
}
